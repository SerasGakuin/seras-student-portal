...
- **講師用ダッシュボード**: 生徒の学習時間分析、ランキング、週間チャンピオン表示、月間ランキングPDF出力（講師・教室長専用）。
- **講師・教室長モード**: 講師による生徒検索、教室長による自習室の開館/閉館管理機能（権限ベースのUI切り替え）。
- **データ分析**: Web上で在室状況のヒートマップ・トレンドグラフや月間ランキングを分析・PDF出力。Python/Jupyter環境（`analysis/`）では探索的データ分析も可能。
...
- **[分析機能 開発ガイド](./docs/analysis-dev-guide.md)**: データ分析機能の追加手順
